...
export class GroupResolverBase {
  ...
  @graphql.ResolveField(() => [GroupChat], { name: "groupChats" })
  async findGroupChats(
    @graphql.Parent() parent: Group,
    @graphql.Args() args: GroupChatFindManyArgs
  ): Promise<GroupChat[]> {
    const results = await this.service.findGroupChats(parent.id, args);
  ...
  @graphql.ResolveField(() => [GroupCall], { name: "groupCalls" })
  async findGroupCalls(
    @graphql.Parent() parent: Group,
    @graphql.Args() args: GroupCallFindManyArgs
  ): Promise<GroupCall[]> {
    const results = await this.service.findGroupCalls(parent.id, args);
